...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        _RandomGenerator randomGenerator = new _RandomGenerator();
        ...
        List<_Customer> customers = new ArrayList<_Customer>(CUSTOMER_COUNT);

        for (int i=1; i<=CUSTOMER_COUNT; i++) {
            System.out.println(String.format("_Customer id: %d", i));
            ...
            _Customer customer = new _Customer(i, name, age, countryCode, salary);
        ...
        for (_Customer customer : customers) {
            ...
            _CsvUtils.writeLine(customerWriter, list);
        }
        ...
        List<_Transaction> transactions = new ArrayList<_Transaction>(TRANSACTION_COUNT);
        ...
        for (int i=1; i<=TRANSACTION_COUNT; i++) {
            ...
            if (counter <= currentTotal) {
                ...
                sum += currentTotal;
                System.out.println(String.format("_Transaction id: %d, customer id: %d, transactions count: %d, mean: %d", i, currentId, currentTotal, sum/currentId));
            ...
            _Transaction transaction = new _Transaction(i, customerId, total, itemCount, description);
        ...
        for (_Transaction transaction : transactions) {
            ...
            _CsvUtils.writeLine(transactionWriter, list);
        }
